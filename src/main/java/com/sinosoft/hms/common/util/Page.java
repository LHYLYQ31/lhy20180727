...
public class Page {
    ...
    private int showCount = ConfigProperties.getIntPropertyValue(GlobalNames.PAGE_SIZE, GlobalNames.DEFAULT_PAGE_SIZE); //每页显示记录数
     ...
     * 
     * @param showCount 记录数
     * @param totalResult 记录总数
     * @param currentPage 当前页
     * @param recordList 当前页数据
     */
