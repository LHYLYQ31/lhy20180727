...
public class ConfigProperties {
    ...
    public static final String CONFIG_FILENAME = "config/configs.properties";
    ...
    static {
        ...
        if (url != null) {
            try {
                ...
                log.error(new StringBuffer().append("加载属性配置文件[").append(CONFIG_FILENAME).append("]出错!").toString(),
                        e);
            }
        }
        else {
     ...
     * @return float单浮点型
     */
    public static float getFloatPropertyByKey(PropertiesConfiguration configuration, String strKey,
            float defaultValue) {
        if (configuration.containsKey(strKey)) {
     ...
     */
    public static void saveProperties(String propertiesFileName, Map<String, Object> map)
            throws ConfigurationException {
