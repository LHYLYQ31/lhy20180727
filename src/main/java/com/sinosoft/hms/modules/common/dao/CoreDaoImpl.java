...
public class CoreDaoImpl implements CoreDao {
     ...
     * parameters 参数
     */
    public List<?> queryList(Class<?> c, String[] whereParameter, final Object[] parameters) {
        final StringBuffer hql = new StringBuffer();
        hql.append("FROM " + c.getSimpleName() + " o ");
     ...
     */
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public List<?> getByIds(Class<?> c, final Long[] ids) {
        ...
        return (List<?>) hibernateTemplate.execute(new HibernateCallback() {
            @Override
            public Object doInHibernate(Session session) throws HibernateException {
                return session.createQuery("FROM " + c.getSimpleName() + " WHERE id IN(:ids)").setParameterList(
                        "ids", ids)//
                        .list();
            }
        });
     ...
     */
    @Override
    public void updateCloum(Class<?> clazz, Serializable id, String[] cloumParameter, Object[] parameters)
            throws Exception {
     ...
     */
    @Override
    public Object queryCloums(Class<?> clazz, Serializable id, String idCloumName, String cloum) throws Exception {
        Session session = hibernateTemplate.getSessionFactory().getCurrentSession();
    ...
    public void updateBlobData(final String tableName, final String blobCloumName, final String[] whereCloumNames,
            final Object[] whereParameters, final byte[] data) throws Exception {
    ...
    private void updateLobData(final String type, final String tableName, final String lobCloumName,
            final String[] whereCloumNames, final Object[] whereParameters, final byte[] data) throws Exception {
        Session session = hibernateTemplate.getSessionFactory().getCurrentSession();
